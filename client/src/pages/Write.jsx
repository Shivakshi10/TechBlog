    ...
    <div className='add'> 
      ...
      <div className="menu">
        ...
        <div className="item">
          ...
          <div className="cats">
 <input type='radio' name='cat' value="science" checked={cat === "science"} id='science' onChange={e=>setCat(e.target.value)}/>
          <label htmlFor='science'>Science</label>
          </div>
          <div className="cats">
            <input type='radio' name='cat' value="technology" checked={cat === "technology"} id='technology' onChange={e=>setCat(e.target.value)}/>
